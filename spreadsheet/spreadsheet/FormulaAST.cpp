...
public:
    ...
    virtual double Evaluate(function<double(Position)>& args) const = 0;
...
public:
    ...
    double Evaluate(function<double(Position)>&) const override {
        return value_;
    }
...
double FormulaAST::Execute(function<double(Position)>& args) const {
